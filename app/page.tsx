        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-between items-center py-4">
            <nav className="flex items-center gap-6">
              <Link href="/solucoes" className="flex items-center gap-1 font-medium">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 z-10">
            ...
            <p className="text-xl md:text-2xl mb-6">
              Desbloqueie o potencial do seu negócio com soluções de automação avançadas, integrando inteligência
              artificial para otimizar a comunicação e maximizar resultados.
            </p>
